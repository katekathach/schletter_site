<?php
# PHPFMG_ID:'20130919-bc69'
# Date : 20130919 22:45:03
# Generated By Free PHP Formmail Generator : http://phpfmg.sourceforge.net
# -----------------------------------------------------------------------------
//session_start(); // start up your PHP session!
//$formMail = $_SESSION['form_mail'];
define( 'PAYPAL_ID' , '5203294278576262' ); // Put donation ID here to disable the bottom backlink
define( 'PHPFMG_TO' , "mail.us@schletter-group.com" );

define( 'PHPFMG_REDIRECT', 'ground-quote-confirmed.php' );

define( 'PHPFMG_ID' , '20130919-bc69' );
...
if( !defined('PHPFMG_ADMIN_URL') ) define( 'PHPFMG_ADMIN_URL' , 'ground-mount-checklist/admin.php' ); // might be defined already by wordpress form loader plugin
...
define( 'PHPFMG_HARMFUL_EXTS' , ".php, .html, .css, .js, .exe, .com, .bat, .vb, .vbs, scr, .inf, .reg, .lnk, .pif, .ade, .adp, .app, .bas, .chm, .cmd, .cpl, .crt, .csh, .fxp, .hlp, .hta, .ins, .isp, .jse, .ksh, .Lnk, .mda, .mdb, .mde, .mdt, .mdw, .mdz, .msc, .msi, .msp, .mst, .ops, .pcd, .prf, .psd, .prg, .pst, .scf, .scr, .sct, .shb, .shs, .url, .vbe, .wsc, .wsf, .wsh" );
define( 'PHPFMG_HARMFUL_EXTS_MSG' , 'File type is not allowed. Please select a different file type.' );
define( 'PHPFMG_ALLOW_EXTS' , ".jpg, .gif, .png, .bmp, .pdf, .doc, .xlsx, .csv , .dwg" );
define( 'PHPFMG_ALLOW_EXTS_MSG' , "Upload is not allowed. Please check your file type." );

define( 'PHPFMG_SUBJECT' , "Ground Mount Quote" );

define( 'PHPFMG_CC' , 'marketing.us@schletter-group.com');
define( 'PHPFMG_BCC', 'kateka.thach@schletter-group.com' );

// for auto-response email
define( 'PHPFMG_RETURN_ENABLE' , 'Y' );  // 'Y' to enable auto-response email, use '' or 'N' to turn off
define( 'PHPFMG_YOUR_NAME' , 'Schletter Inc.' ); // name of auto-response mail address
define( 'PHPFMG_RETURN_EMAIL' , "mail.us@schletter-group.com" );
define( 'PHPFMG_RETURN_SUBJECT' , "Ground Mount Quote" ); // auto-response mail subject
...
define( 'PHPFMG_NO_FROM_HEADER' , 'Y' ); // don't make up From: header.
define( 'PHPFMG__FROM' , 'mail.us@schletter-group.com' ); // force sender's email
...
define( 'RECAP_SITE_KEY' , "6Lf--x0TAAAAAHw1zSQVb1u3Cdr8Neq_8i1rjQk4" );
define( 'RECAP_SECRET_KEY' , "6Lf--x0TAAAAACNKbFjGx-UTVffYtos_MxppJMDI" );
...
//define( 'PHPFMG_REFERERS_ALLOW', " schletter.us, schletter.ca,12.31.70.66, mail.schletter-inc.us" ); // Referers - domains/ips that you will allow forms to reside on.
//define( 'PHPFMG_REFERERS_DENIED_MSG', "You are coming from an <b>unauthorized domain.</b>" );
define( 'PHPFMG_REFERERS_ALLOW', "http://72.167.13.32, 72.167.13.32, http://192.169.189.144 , http://192.169.189.143, schletter.us, schletter.ca,12.31.70.66, mail.schletter-inc.us " ); // Referers - domains/ips that you will allow forms to reside on.
define( 'PHPFMG_REFERERS_DENIED_MSG', "You are coming from an <b>unauthorized domain.</b>" );
...
<strong>Thank you for submitting a ground mount quote request.</strong> We will get back to you shortly.
<br/>
...
If you have any questions please email us at <a href="mailto:mail.us@schletter-group.com" style="color:#006238;">mail.us@schletter-group.com</a>
or call us at (888) 608-0234.
<br/>
<br/>
Thank you,
<br/>
<br/>
Schletter Inc.<br/>
<a href="http://www.schletter.us" style="color:#006238;">www.schletter.us</a><br/><br/>
<?php
    $msg = ob_get_contents() ;
    ob_end_clean();
    return trim($msg);
...
<strong>Sales, please provide a project quote as soon as possible.</strong><br/><br/>
%DataOfForm%
...
$GLOBALS['form_mail']['field_11'] = array( "name" => "field_11", "text" => "Company Legal Name",  "type" => "senderfirstname", "instruction" => "", "required" => "Required" ) ;

$GLOBALS['form_mail']['field_2'] = array( "name" => "field_2", "text" => "Company Address",  "type" => "text", "instruction" => "", "required" => "Required" ) ;

$GLOBALS['form_mail']['field_12'] = array( "name" => "field_12", "text" => "if DBA: Name",  "type" => "text", "instruction" => "", "required" => "" ) ;

$GLOBALS['form_mail']['field_13'] = array( "name" => "field_13", "text" => "Contact Name",  "type" => "senderfirstname", "instruction" => "", "required" => "Required" ) ;

$GLOBALS['form_mail']['field_15'] = array( "name" => "field_15", "text" => "Contact E-mail",  "type" => "generic email", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_16'] = array( "name" => "field_16", "text" => "Contact Phone Number",  "type" => "", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_4'] = array( "name" => "field_4", "text" => "Total Project Size(kW)",  "type" => "text", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_5'] = array( "name" => "field_5", "text" => "Project Name",  "type" => "text", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_6'] = array( "name" => "field_6", "text" => "Project Address",  "type" => "text", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_0'] = array( "name" => "field_0", "text" => "Sales Associate",  "type" => "select", "instruction" => "", "required" => "" ) ;
$GLOBALS['form_mail']['field_19'] = array( "name" => "field_19", "text" => "PE Structural Stamps Needed",  "type" => "radio", "instruction" => "", "required" => "Required" ) ;

$GLOBALS['form_mail']['field_31'] = array( "name" => "field_31", "text" => "Terrain Category",  "type" => "radio", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_32'] = array( "name" => "field_32", "text" => "Occupancy Cat",  "type" => "select", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_30'] = array( "name" => "field_30", "text" => "ASCE Version",  "type" => "select", "instruction" => "", "required" => "" ) ;
$GLOBALS['form_mail']['field_33'] = array( "name" => "field_33", "text" => "Wind Load(mph)",  "type" => "text", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_34'] = array( "name" => "field_34", "text" => "Snow Load(psf)",  "type" => "text", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_35'] = array( "name" => "field_35", "text" => "If terrain D: Proximity to Coast(mi)",  "type" => "text", "instruction" => "", "required" => "" ) ;
$GLOBALS['form_mail']['field_37'] = array( "name" => "field_37", "text" => "Module Model/Brand/Wattage",  "type" => "text", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_39'] = array( "name" => "field_39", "text" => "Module Quantity",  "type" => "text", "instruction" => "", "required" => "Required" ) ;

$GLOBALS['form_mail']['field_42'] = array( "name" => "field_42", "text" => "Height (mm)",  "type" => "text", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_43'] = array( "name" => "field_43", "text" => "Width (mm)",  "type" => "text", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_44'] = array( "name" => "field_44", "text" => "Thickness (mm)",  "type" => "text", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_45'] = array( "name" => "field_45", "text" => "Weight (kg)",  "type" => "text", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_46'] = array( "name" => "field_46", "text" => "Module Tilt",  "type" => "text", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_47'] = array( "name" => "field_47", "text" => "Module Orientation",  "type" => "checkbox", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_40'] = array( "name" => "field_40", "text" => "Array Configuration",  "type" => "text", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_41'] = array( "name" => "field_41", "text" => "Select Your System",  "type" => "radio", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_54'] = array( "name" => "field_54", "text" => "Describe other site or rack characteristics",  "type" => "textarea", "instruction" => "", "required" => "");
$GLOBALS['form_mail']['field_62'] = array( "name" => "field_62", "text" => "If carport: type",  "type" => "radio", "instruction" => "", "required" => "" ) ;
$GLOBALS['form_mail']['field_75'] = array( "name" => "field_75", "text" => "Uploaded File",  "type" => "attachment", "instruction" => "", "required" => "" ) ;
?>
<?php
/**
...
function deleteUpload($delete){
	if(isset($deletepath) && $deletepath == true)
        {
            unlink(PHPFMG_SAVE_ATTACHMENTS_DIR);
			unlink($deletepath);
...
function phpfmg_display_form( $title="", $keywords="", $description="" ){
    ...
    $phpfmg_send = phpfmg_( $GLOBALS['form_mail'] ) ;
...
function phpfmg_( &$form_mail ) {
    ...
    if( empty($sErr['fields']) ){
		...
		//generate pdf file
		generatePdf($form_mail, PHPFMG_SAVE_FILE);
		$formMail = $form_mail;
		//send email
		sendFormMail( $form_mail, PHPFMG_SAVE_FILE ) ;
		//generate pdf file
		//generatePdf($form_mail);
		$isHideForm = true;
...
function  sendFormMail( $form_mail, $sFileName = ""  )
{
    ...
    The mailer HAS to use the REGISTERED email address as the sender's email address. This is called the _from.
    */
    $_from = $from;
    $sender_email  = $_POST['field_15'];
    $force_sender = defined('PHPFMG__FROM') && '' != PHPFMG__FROM ;
    if( $force_sender ){
        ini_set("_from", PHPFMG__FROM);
        $_from = PHPFMG__FROM;
    };
    ...
    switch( strtolower(PHPFMG_ACTION) ){
        case 'fileonly' :
               ...
               break;
        case 'mailonly' :
              mailAttachments( $to , $subject , $content, $_from, $fromName, $fromHeader,  $cc , $bcc, PHPFMG_CHARSET ) ;
        	   break;
        case 'mailandfile' :
        default:
              mailAttachments( $to , $subject , $content, $_from, $fromName, $fromHeader,  $cc , $bcc, PHPFMG_CHARSET ) ;
	...
	mailAutoResponse( $sender_email, $force_sender ? $_from : $to, $fields ) ;
    umask($oldMask);
...
//Save data to PDF
function generatePdf($form_mail, $sFileName = ""){
	ob_start();
	include_once('mpdf/mpdf.php');
	// require_once("pdf.inc");
	$mpdf = new mPDF();
	...
	$lastName  = "";
    	...
    	$strip     = get_magic_quotes_gpc();
    	$content   = '';
    	$style     = 'font-family:Arial, Helvetica, sans-serif; font-size : 13px; color:#474747;padding:6px;border-bottom:1px solid #cccccc;' ;
    	$tr        = array(); // html table
    	$csvValues = array();
    	$cols      = array();
    	$replace   = array();
	...
	$mpdf->useOddEven = 1;
	//$mpdf->DefHTMLHeaderByName('logo','<div style="text-align: right; border-bottom: 1px solid #000000; font-weight: bold; font-size: 10pt; "><img style=" "
	//src="images/schletter-logo.png" title="Schletter Solar Mounting Systems" alt="Schletter Solar Mounting Systems"></div>');
	 $mpdf->SetHTMLHeader('<div style="margin-top:-40px;"><img style="float:right;  " height="51" width="190" src="images/schletter-logo.png" title="Schletter

Solar Mounting Systems" alt="Schletter Solar Mounting Systems"> </div>','O');


	 $mpdf->SetHTMLFooter('<div style="text-align: center; font-weight: bold; font-size: 8pt; font-style: italic;">www.schletter.us | 1001 Comerce Center Drive,

Shelby North Carolina 28150 | (888) 608 - 0234 </div>');
	 //$mpdf->SetHTMLHeaderByName('logo');
	...
	foreach( $form_mail as $field ){
        ...
        $content    .= $field[ "text" ] . " \t : " . $value .PHPFMG_LNCR;
        $tr[]        = "<tr> <td valign=top style='{$style};width:33%;border-right:1px solid #cccccc;'>" . $field[ "text" ] . "&nbsp;</td> <td valign=top

style='{$style};'>" . nl2br($value) . "&nbsp;</td></tr>" ;
        $csvValues[] = csvfield( $value );
        $cols[]      = csvfield( $field[ "text" ] );
        $replace["%".$field[ "name" ]."%"] = $value;
	...
	//$html = "<table width='100%' style='overflow:auto; border: 1px solid #000; vertical-align: center; font-family: serif; font-size: 8pt; color:

#000000;'><tr><td width='50%'><strong>" . $field[ "text" ] . "<td></strong>" . "<td width='50%'>" . nl2br($value) . "</td></tr>" ."</table>";

$mpdf->WriteHTML( "<table width='100%' style='overflow:auto; border: 1px solid #000; vertical-align: center; font-family: Arial; font-size: 8pt; color:

#000000;'><tr style='border:1px solid #000;'><td width='50%' ><strong>" . $field[ "text" ] . "<td></strong>" . "<td width='50%'>" . nl2br($value) . "</td></tr>" ."</table>");


    	};


       $filename = "ground-mount-checklist/pdf/";
	...
	//$mpdf->Output();
	//ob_end_flush();
	//mailAttachments( $_POST['field_15'] , $subject , $html, $_from, $fromName, $fromHeader,  $cc , $bcc, PHPFMG_CHARSET ) ;
	//appendToFile( $sFileName, $record, $recordCols );
	//$filename .= "ground-mount-checklist".date("Ymd").rand()."pdf";
	//$mpdf->Output('test'.date("Ymd") .rand(). '.pdf', '');
	//$mpdf->Close();
}
...
//define( 'reCAPTCHA_PUBLIC_KEY' , "6Lf--x0TAAAAAHw1zSQVb1u3Cdr8Neq_8i1rjQk4" );
//define( 'reCAPTCHA_PRIVATE_KEY' , "6Lf--x0TAAAAACNKbFjGx-UTVffYtos_MxppJMDI" );
function phpfmg_reCAPTCHA_key( $type ){
    $isSitekey = $type == 'site_key';
    // this keys are for formmail-maker.com domain only
    $phpfmgSiteKey   = '6Lf--x0TAAAAAHw1zSQVb1u3Cdr8Neq_8i1rjQk4';
    $phpfmgSecretKey = '6Lf--x0TAAAAACNKbFjGx-UTVffYtos_MxppJMDI';
    if( $isSitekey ){
...
function phpfmg_choice( $type, $name, $options, $showInputbox = false, $isReturn = false ){
    ...
    if( is_array($list) ){
        ...
        foreach( $list as $opt ){
            ...
            $radios[] = "{$labelLeft}<label class='form_choice_text ' for='{$id}'>{$o['text']}<input type='{$type}' name='{$newname}' id='{$id}'  value=\"{$o['value']}\"  {$checked} class='form_{$type}' {$onclick} ><br></label>";
            $i ++ ;
        };
...
function phpfmg_formini(){
    return "";
}
